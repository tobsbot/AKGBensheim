...
public class Log {
    ...
    /**
     * A wrapper for the {@link android.util.Log#i(String, String, java.lang.Throwable)} function
     * @param tag       The tag used in the logcat
    ...
    /**
     * A wrapper for the {@link android.util.Log#d(String, String, java.lang.Throwable)} function
     * @param tag       The tag used in the logcat
     * @param throwable The throwable to print the stack trace of
     * @param message   The message, which can be formatted according to String.format
     * @param args      The arguments, optional
    ...
    /**
     * A wrapper for the {@link android.util.Log#w(String, String, java.lang.Throwable)} function
     * @param tag       The tag used in the logcat
     * @param throwable The throwable to print the stack trace of
     * @param message   The message, which can be formatted according to String.format
     * @param args      The arguments, optional
    ...
    /**
     * A wrapper for the {@link android.util.Log#e(String, String, java.lang.Throwable)} function
     * @param tag       The tag used in the logcat
     * @param throwable The throwable to print the stack trace of
     * @param message   The message, which can be formatted according to String.format
     * @param args      The arguments, optional
